...
async function main() {
    ...
    console.log(chalk.blue("[System] Connecting to database..."));
    const dbConnected = await connectDatabase();
    console.log(dbConnected ? chalk.green("[System] Database connected") : chalk.red("[System] Database connection failed"));
